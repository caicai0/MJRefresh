...
@interface CAIHRefreshAutoFooter()
/** 一个新的拖拽 */
@property (assign, nonatomic, getter=isOneNewPan) BOOL oneNewPan;
@end

@implementation CAIHRefreshAutoFooter
...
- (void)scrollViewContentSizeDidChange:(NSDictionary *)change
{
    ...
    // 设置位置
    self.mj_x = self.scrollView.mj_contentW + self.ignoredScrollViewContentInsetRight;
}
